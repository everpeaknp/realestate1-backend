...
@admin.register(TestimonialsHeroSettings)
class TestimonialsHeroSettingsAdmin(admin.ModelAdmin):
    """Admin for Testimonials Hero Settings (Singleton)"""
    ...
    def has_add_permission(self, request):
        ...
        return not TestimonialsHeroSettings.objects.exists()
